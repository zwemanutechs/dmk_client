  ...
  constructor(props) {
    ...
    this.state = {
      ...
      waterSupplyFromTank4: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.waterSupplyFromTank4,
      },
    };
  }
        ...
        <Grid item xs={12}>
          <FormControl className={this.props.classes.formControl}>
            <NumberFormat
              ...
              label="Tank-4 Water Supply, L/hr"
              customInput={TextField}
              value={this.state.waterSupplyFromTank4.value}
              defaultValue={0.0}
              onValueChange={(value) =>
                this.onChange("waterSupplyFromTank4", value.floatValue)
              }
              ...
              helperText={
                !this.state.waterSupplyFromTank4.valid
                  ? this.state.waterSupplyFromTank4.errorMessage
                  : ""
              }
              disabled={this.props.onFormSubmit}
            />
