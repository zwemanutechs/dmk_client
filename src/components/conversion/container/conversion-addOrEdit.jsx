  ...
  constructor(props) {
    ...
    this.state = {
      waterSupplyFromDiTank: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.waterSupplyFromDiTank,
      },
    };
  }
        ...
        <Grid item xs={12}>
          <FormControl className={this.props.classes.formControl}>
            ...
            <NumberFormat
              ...
              defaultValue={0.0}
              onValueChange={(value) =>
                this.onChange("waterSupplyFromDiTank", value.floatValue)
              }
              ...
              helperText={
                !this.state.waterSupplyFromDiTank.valid
                  ? this.state.waterSupplyFromDiTank.errorMessage
                  : ""
              }
