  ...
  constructor(props) {
    ...
    this.state = {
      paintPressureAtEsta2R11: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.paintPressureAtEsta2R11,
      },
      paintPressureAtEsta1R12: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.paintPressureAtEsta1R12,
      },
      highTensionEsta2R11: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.highTensionEsta2R11,
      },
      paintPressureAtEsta1R11: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.paintPressureAtEsta1R11,
      },
      highTensionEsta1R12: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.highTensionEsta1R12,
      },
      highTensionEsta1R11: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.highTensionEsta1R11,
      },
      touchUpRoom1AirFlow: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.touchUpRoom1AirFlow,
      },
      touchUpRoom2AirFlow: {
        valid: true,
        errorMessage: "",
        value: this.props.dataSet.touchUpRoom2AirFlow,
      },
    };
  }
        ...
        <Grid item xs={12}>
          <FormControl className={this.props.classes.formControl}>
            ...
            <NumberFormat
              ...
              defaultValue={0.0}
              onValueChange={(value) =>
                this.onChange("paintPressureAtEsta2R11", value.floatValue)
              }
              ...
              helperText={
                !this.state.paintPressureAtEsta2R11.valid
                  ? this.state.paintPressureAtEsta2R11.errorMessage
                  : ""
              }
              disabled={this.props.onFormSubmit}
            />
        ...
        <Grid item xs={12}>
          <FormControl className={this.props.classes.formControl}>
            ...
            <NumberFormat
              ...
              defaultValue={0.0}
              onValueChange={(value) =>
                this.onChange("highTensionEsta2R11", value.floatValue)
              }
              ...
              helperText={
                !this.state.highTensionEsta2R11.valid
                  ? this.state.highTensionEsta2R11.errorMessage
                  : ""
              }
              disabled={this.props.onFormSubmit}
            />
        ...
        <Grid item xs={12}>
          <FormControl className={this.props.classes.formControl}>
            ...
            <NumberFormat
              ...
              defaultValue={0.0}
              onValueChange={(value) =>
                this.onChange("touchUpRoom1AirFlow", value.floatValue)
              }
              ...
              helperText={
                !this.state.touchUpRoom1AirFlow.valid
                  ? this.state.touchUpRoom1AirFlow.errorMessage
                  : ""
              }
              disabled={this.props.onFormSubmit}
            />
        ...
        <Grid item xs={12}>
          <FormControl className={this.props.classes.formControl}>
            ...
            <NumberFormat
              ...
              defaultValue={0.0}
              onValueChange={(value) =>
                this.onChange("touchUpRoom2AirFlow", value.floatValue)
              }
              ...
              helperText={
                !this.state.touchUpRoom2AirFlow.valid
                  ? this.state.touchUpRoom2AirFlow.errorMessage
                  : ""
              }
              disabled={this.props.onFormSubmit}
            />
