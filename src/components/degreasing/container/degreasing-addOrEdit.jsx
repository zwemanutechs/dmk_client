...
class DegreasingAddOrEdit extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            concentrationTopUp: {valid: true, errorMessage: '', value: this.props.dataSet.concentrationTopUp},
            waterSupplyFromTank2: {valid: true, errorMessage: '', value: this.props.dataSet.waterSupplyFromTank2},
            oilSkimming: {valid: true, errorMessage: '', value: this.props.dataSet.oilSkimming},
            dyneTest: {valid: true, errorMessage: '', value: this.props.dataSet.dyneTest}
        }
    }
                ...
                <Grid item xs={12}>
                    <FormControl className={this.props.classes.formControl}>
                        ...
                        <Grid component="label" container alignItems="center" spacing={1}>
                            <Grid item>No</Grid>
                            <Grid item>
                                <Switch checked={this.state.concentrationTopUp.value} onChange={event => {
                ...
                <Grid item xs={12}>
                    <FormControl className={this.props.classes.formControl}>
                        <NumberFormat
                            ...
                            fullWidth={true}
                            defaultValue={0.00}
                            onValueChange={value => this.onChange('waterSupplyFromTank2', value.floatValue)}
                            ...
                            helperText={!this.state.waterSupplyFromTank2.valid ? this.state.waterSupplyFromTank2.errorMessage : ''}
                            disabled={this.props.onFormSubmit}
                        />
                    </FormControl>
                </Grid>
                ...
                <Grid item xs={12}>
                    <FormControl className={this.props.classes.formControl}>
                        <NumberFormat
                            ...
                            fullWidth={true}
                            defaultValue={0.00}
                            onValueChange={value => this.onChange('oilSkimming', value.floatValue)}
                            ...
                            helperText={!this.state.oilSkimming.valid ? this.state.oilSkimming.errorMessage : ''}
                            disabled={this.props.onFormSubmit}
                        />
                    </FormControl>
                </Grid>
                ...
                <Grid item xs={12}>
                    <FormControl className={this.props.classes.formControl}>
                        <NumberFormat
                            ...
                            fullWidth={true}
                            defaultValue={0.00}
                            onValueChange={value => this.onChange('dyneTest', value.floatValue)}
                            ...
                            helperText={!this.state.dyneTest.valid ? this.state.dyneTest.errorMessage : ''}
                            disabled={this.props.onFormSubmit}
                        />
                    </FormControl>
                </Grid>
